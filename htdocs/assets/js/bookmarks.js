...
/***/ (function(module, exports, __webpack_require__) {
	...
	Bookmarks = __webpack_require__(2);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Bookmarks, Contents,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	
	Contents = __webpack_require__(3);
	
	Bookmarks = (function(superClass) {
	  extend(Bookmarks, superClass);
	
	  function Bookmarks() {
	    Bookmarks.__super__.constructor.call(this, 'bookmarks');
	  }
	
	  Bookmarks.prototype.init = function() {
	    Bookmarks.__super__.init.call(this);
	    this.initThumbs();
	    this.initSearchPanel('bookmarks');
	    this.initBtnBack('bookmarks');
	    this.initImgs('article.main .capture img');
	    this.$window.on('resize.contents', this.resizeSearchPanel).trigger('resize.contents');
	  };
	
	  Bookmarks.prototype.start = function() {
	    tkmh.animateToTtl('bookmarks');
	  };
	
	  Bookmarks.prototype.reset = function() {
