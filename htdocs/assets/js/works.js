...
/***/ (function(module, exports, __webpack_require__) {
	...
	Works = (function(superClass) {
	  extend(Works, superClass);
	
	  function Works() {
	    Works.__super__.constructor.call(this, 'works');
	  }
	
	  Works.prototype.init = function() {
	    Works.__super__.init.call(this);
	    this.initThumbs();
	    this.initSearchPanel('works');
	    this.initImgs('article.main .img img');
	    this.initBtnBack('works');
	    this.initThumbsInteraction('section.articles article .thumb', 20, 10);
	    this.$window.on('resize.contents', (function(_this) {
	      return function(e) {
	        var i, len, ref, thumb;
	        _this.resizeSearchPanel();
	        if (utils.isDesktop) {
	          ref = _this.thumbs;
	    ...
	    })(this)).trigger('resize.contents');
	  };
	
	  Works.prototype.start = function() {
	    tkmh.animateToTtl('works');
	  };
	
	  Works.prototype.reset = function() {
	    this.resetSearchPanel();
	    this.resetBtnBack();
	    this.disposeThumbsInteraction();
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Contents = (function() {
	  ...
	  Contents.prototype.initSearchPanel = function(dir) {
	    var $keywordInput, toggleContens;
	    ...
	    this.$btnCategories = this.$searchPanel.find('.btnCategories').on('click', (function(_this) {
	      return function(e) {
	        toggleContens(_this.$btnCategories, _this.$categories);
	        toggleContens(_this.$btnTags, _this.$tags, false);
	        toggleContens(_this.$btnMonthlyArchives, _this.$monthlyArchives, false);
	        toggleContens(_this.$btnKeyword, _this.$keyword, false);
	        return false;
	      };
	    })(this));
	    this.$btnTags = this.$searchPanel.find('.btnTags').on('click', (function(_this) {
	      return function(e) {
	        toggleContens(_this.$btnCategories, _this.$categories, false);
	        toggleContens(_this.$btnTags, _this.$tags);
	        toggleContens(_this.$btnMonthlyArchives, _this.$monthlyArchives, false);
	        toggleContens(_this.$btnKeyword, _this.$keyword, false);
	        return false;
	      };
	    ...
	    this.$btnMonthlyArchives = this.$searchPanel.find('.btnMonthlyArchives').on('click', (function(_this) {
	      return function(e) {
	        toggleContens(_this.$btnCategories, _this.$categories, false);
	        toggleContens(_this.$btnTags, _this.$tags, false);
	        toggleContens(_this.$btnMonthlyArchives, _this.$monthlyArchives);
	        toggleContens(_this.$btnKeyword, _this.$keyword, false);
	        return false;
	      };
	    })(this));
	    this.$btnKeyword = this.$searchPanel.find('.btnKeyword').on('click', (function(_this) {
	      return function(e) {
	        ...
	        toggleContens(_this.$btnTags, _this.$tags, false);
	        toggleContens(_this.$btnMonthlyArchives, _this.$monthlyArchives, false);
	        toggleContens(_this.$btnKeyword, _this.$keyword);
	        return false;
	      };
	    })(this));
	  };
